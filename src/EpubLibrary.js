...
import LibraryNavbar from '../resources/templates/library-navbar.html';
import LibraryBody from '../resources/templates/library-body.html';
import EmptyLibrary from '../resources/templates/empty-library.html';
import LibraryItem from '../resources/templates/library-item.html';
import DetailsDialog from '../resources/templates/details-dialog.html';
import AboutDialog from '../resources/templates/about-dialog.html';
import DetailsBody from '../resources/templates/details-body.html';
import AddEpubDialog from '../resources/templates/add-epub-dialog.html';
import SettingsDialog from './ReaderSettingsDialog';
import Dialogs from './Dialogs';
import Messages from './workers/Messages';
...
var loadDetails = function(e) {
  ...
  var retrieveDetails = function(packageUrl) {
    ...
    libraryManager.retrieveFullEpubDetails(
      packageUrl,
      bookRoot,
      rootDir,
      noCoverBg,
...
var importZippedEpubs = function(files, i) {
  ...
  if (i == 0) {
    ...
    if (importZippedEpubs_CANCELLED) {
      ...
      setTimeout(function() {
        Dialogs.showModalMessage(
          Strings.i18n_add_book,
          Strings.i18n_cancel + ' - ' + Strings.import_dlg_title,
        );
      }, 800);
